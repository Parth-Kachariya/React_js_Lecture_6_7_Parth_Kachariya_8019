...
import { FaEdit, FaTrash, FaEnvelope, FaPhone, FaMapMarkerAlt, FaUser, FaTimes } from 'react-icons/fa';
    ...
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-gray-100">
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
        <div className="flex justify-between items-center">
          {isEditing ? (
            <h5 className="text-xl font-semibold text-white">Edit Student</h5>
          ) : (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h5 className="text-xl font-semibold text-white">{student.name}</h5>
                <span className="text-blue-100 text-sm">Roll No: {student.rollNumber}</span>
              </div>
            </div>
          )}
          {!isEditing && (
